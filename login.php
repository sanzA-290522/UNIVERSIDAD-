...
<body id="FondoL">
    <div class="form-container">
        ...
        <form class="form">
            <input type="email" class="input" name="Correo electrónico">
            <input type="password" class="input" name="Contraseña">
            <p class="page-link">
                <span class="page-link-label">¿Olvido su contraseña?</span>
            </p>
            <button class="form-btn">Inicia sesión</button>
        </form>
        <p class="sign-up-label">
        ¿No tienes una cuenta?<span class="sign-up-link"><a href="registro.php">Registrate</a></span>
        </p>
